...
const dictionary: Dictionary = {
  ...
  onsiteDesc: {
    zh: "普通检品、出差检品、X光检品和二次检品分开处理，最终报告会自动扣除返修转良数量。",
    en: "Normal QC, field QC, X-ray QC, and reinspection are handled separately. Final reports deduct repaired pass quantities.",
    ja: "通常検品、出張検品、X線検品、二次検品を分けて処理し、最終報告では修理後の良品数を自動控除します。"
  },
  startInspection: { zh: "开始检品", en: "Start QC", ja: "検品開始" },
  fieldInspection: { zh: "出差检品", en: "Field QC", ja: "出張検品" },
  ...
  fieldFinalFailed: { zh: "出差最终未过", en: "Field final failed", ja: "出張最終不合格" },
  ...
  fieldQc: { zh: "出差检品", en: "Field QC", ja: "出張検品" },
